    ...
    'K083': KnowledgeExtensionBundle(
      ...
      questions: [
        KnowledgeQuestion(
          ...
          answer: false,
          analysis: '聊天积极只是必要条件，不是充分条件。如果她从不单独约会你、从不推进关系、回避升温话题，说明她可能只是把你当朋友备胎。判断可发展对象需要多维信号，聊天只是其中之一。',
          difficulty: 'easy',
        ),
        KnowledgeQuestion(
          id: 'K083-Q2',
          ...
          answer: 1,
          analysis: '明确表态是止损信号里最直接的。选项A/C/D都可能是对方在忙或性格原因，不构成止损条件。只有对方明确表态"只想做朋友"且态度坚定，才应立即减少投入、转向其他机会。',
          difficulty: 'easy',
        ),
        KnowledgeQuestion(
          id: 'K083-Q3',
          ...
          instruction: 'A. 继续加大投入，用热情打动她  B. 停止主动，等她来找你并观察是否改变  C. 直接问她到底什么意思  D. 找她身边的朋友打听情况',
          options: ['继续加大投入，用热情打动她', '停止主动，等她来找你并观察是否改变', '直接问她到底什么意思', '找她身边的朋友打听情况'],
          answer: 1,
          analysis: '忽冷忽热的本质是她对这段关系态度不明朗或正在权衡。选项A只会让你消耗更多；选项C在关系不明朗时直接追问会让对方有压力；选项D打探朋友是大忌。选项B是成本最低、最体面的策略：停止主动，看她是否主动找你，从而判断她的真实兴趣。',
          difficulty: 'medium',
        ),
        KnowledgeQuestion(
          id: 'K083-Q4',
          ...
          answer: [0, 1, 2],
          analysis: '选项0（愿单独约会）是升温的最直接信号。选项1（记得细节）说明她在认真关注你，不是随口敷衍。选项2（介绍朋友）说明她愿意把你纳入社交圈，是关系升级的强信号。选项3（深夜聊天）只是社交活跃的表现，不构成关系发展的明确信号。',
          difficulty: 'medium',
        ),
      ],
    ),
    ...
    'K084': KnowledgeExtensionBundle(
      ...
      questions: [
        KnowledgeQuestion(
          ...
          answer: false,
          analysis: '他对你好可能只是他的性格或习惯，不等于他想认真发展关系。有些人天生对所有人都很好，有些人只是享受暧昧的感觉。判断可发展对象要看：① 是否主动推进关系 ② 是否把你纳入社交圈 ③ 是否做出关系承诺。单纯的好不等于认真定位。',
          difficulty: 'easy',
        ),
        KnowledgeQuestion(
          id: 'K084-Q2',
          ...
          answer: 2,
          analysis: '"不想谈恋爱"但继续享受你的陪伴是典型的备胎定位。选项A继续投入只会让你消耗更多；选项B直接切断太激进；选项D保持模糊对双方都没有好处。选项C明确立场让他做选择，既保护了自己，也给了对方机会，是最体面的策略。',
          difficulty: 'medium',
        ),
        KnowledgeQuestion(
          id: 'K084-Q3',
          ...
          answer: [0, 1, 2],
          analysis: '选项0（单独约且不取消）是关系推进的最直接信号。选项1（记得细节）说明他在认真关注你，是真实兴趣。选项2（见朋友/家人）说明他在认真考虑这段关系的长期发展。选项3（发哈哈）只是聊天活跃的表现，不构成关系发展的明确信号。',
          difficulty: 'medium',
        ),
        KnowledgeQuestion(
          id: 'K084-Q4',
          ...
          answer: 2,
          analysis: '一个有正常社交生活的人，通常会在朋友圈发一些私人内容。如果他对你屏蔽朋友圈，或者朋友圈里几乎没有任何私人生活展示（只有工作转发），需要警惕——他可能在隐藏自己的感情状态，或者有不想让你知道的社交圈。选项A/B/D都不能直接推断有伴侣。',
          difficulty: 'medium',
        ),
      ],
    ),
