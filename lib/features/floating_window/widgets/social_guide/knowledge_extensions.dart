  ...
  static final Map<String, KnowledgeExtensionBundle> _bundles = {
    ...
    'K080': KnowledgeExtensionBundle(
      ...
      stepGuides: [
        ...
        KnowledgeStepGuide(
          id: 'K080-G3',
          title: '实战情景：一次完整的「认识→邀约→推进」演练',
          scenario: '把脱单三步法套进一个真实生活场景里走一遍',
          steps: [
            KnowledgeGuideStep(
              title: '情景开场：你在兴趣班认识了个同频的人',
              instruction: '先确认「三次法则」已满足——已经有过三次正向互动，再谈推进，避免一厢情愿。',
              example: '已经一起拍过两次外拍、群里聊过器材，这是第三次愉快互动。',
              tip: '推进前先自问「对方和我互动是双向的吗」，别被自己的喜欢带偏。',
              keywords: ['共同语境', '三次互动', '确认双向'],
            ),
            KnowledgeGuideStep(
              title: '推进一：具体邀约',
              instruction: '用「具体时间+具体事+低压力」邀约，给可拒绝的退路，反而显得松弛真实。',
              example: '"这周六下午那个展你还去吗？我打算去，要不一起，完了附近喝杯咖啡？"',
              tip: '邀约带退路比「想约你」式的直球更顺，对方压力小、答应率高。',
              keywords: ['具体邀约', '低压力', '留退路'],
            ),
            KnowledgeGuideStep(
              title: '推进二：现场制造暧昧窗口',
              instruction: '见面时专注对方、自然靠近、气氛到位时给正向信号（夸细节、记喜好），靠「做」不靠「问」。',
              example: '看到她喜欢的画，说"这个色调跟你上次聊的气质很像"——把观察和她本人连起来。',
              tip: '自然称呼、轻碰肩膀比当场表白更顺，暧昧窗口是做出来的。',
              keywords: ['现场互动', '暧昧窗口', '自然信号'],
            ),
            KnowledgeGuideStep(
              title: '推进三：事后收尾与下次钩子',
              instruction: '当天结束给一句有温度但不黏的反馈，并埋下「还有下次」的钩子，小步推进关系。',
              example: '"今天挺开心，下次那个新开的店我们再去探探？"——把关系推到「还有下次」。',
              tip: '推进不是一次表白定终身，而是一次次小步确认对方愿意继续。',
              keywords: ['收尾', '下次钩子', '小步推进'],
            ),
          ],
        ),
      ],
    ...
    'K081': KnowledgeExtensionBundle(
      ...
      stepGuides: [
        ...
        KnowledgeStepGuide(
          id: 'K081-G3',
          title: '实战情景：识破一个「看起来很优秀」的人',
          scenario: '对一个新认识、表面光鲜的人做一轮完整尽调',
          steps: [
            KnowledgeGuideStep(
              title: '情景开场：朋友圈精修、谈吐得体，但你没深交过',
              instruction: '表面优秀不等于值得深交。先进入观察期，不急着拉进核心圈，看持续一致性。',
              example: '他发豪车豪宅、饭局合影，但你从没见他做过一件具体靠谱的小事。',
              tip: '看「他做了什么」而非「他展示了什么」。',
              keywords: ['观察期', '一致性', '不急'],
            ),
            KnowledgeGuideStep(
              title: '第一步：小合作测靠谱',
              instruction: '抛一个具体的小协作（探店/拼单/约运动），看他答应的事做没做到、守没守时。',
              example: '约好周六上午爬山，他周五说"稳了"，结果当天睡过头放鸽子。',
              tip: '一次放鸽子是信号，两次就是结论。',
              keywords: ['小合作', '守时', '靠谱度'],
            ),
            KnowledgeGuideStep(
              title: '第二步：压力情景看人品',
              instruction: '在需要让步、吃亏或帮小忙的情境里看他反应，对弱者/服务者的态度最真实。',
              example: '外卖送错，他是好好沟通还是冲店员发火。',
              tip: '对上谄、对下傲的人，再光鲜也别深交。',
              keywords: ['压力测试', '对弱者态度', '人品'],
            ),
            KnowledgeGuideStep(
              title: '第三步：决策——深交还是降权',
              instruction: '信号综合：持续输出质量+靠谱+情绪稳定=可深交；只展示不落地/放鸽子/对下傲慢=降权甚至远离。',
              example: '三次小合作两次掉链子，把他从「可深交候选」移到「普通点头之交」。',
              tip: '优秀是做出来的，不是P出来的。',
              keywords: ['综合信号', '降权', '远离'],
            ),
          ],
    ...
    'K082': KnowledgeExtensionBundle(
      ...
      stepGuides: [
        ...
        KnowledgeStepGuide(
          id: 'K082-G3',
          title: '实战情景：一条「成就动态」从构思到发布',
          scenario: '把一条容易炫耀的成就动态，改成既展示又不得罪人的版本',
          steps: [
            KnowledgeGuideStep(
              title: '情景开场：你考过了个有分量的证，想发又怕炫耀',
              instruction: '先定「展示但不招恨」的基调：功劳分人、语气谦逊、结尾留钩子。',
              example: '原始想法："我过了！牛不牛"——改成"团队carry+运气+求安利"。',
              tip: '成就动态的底色是感恩和分享，不是宣告胜利。',
              keywords: ['基调', '谦逊', '分享'],
            ),
            KnowledgeGuideStep(
              title: '第一步：配图与文案比例',
              instruction: '一张克制截图/合影，文案控制在3行内，把「我」换成「我们/顺便」。',
              example: '"项目终于上线🎉 一半靠队友，一半靠运气——顺便问大家最近都在用哪款协作工具？"',
              tip: '图文都克制，信息密度高但不压迫。',
              keywords: ['克制配图', '短文案', '信息密度'],
            ),
            KnowledgeGuideStep(
              title: '第二步：结尾钩子引互动',
              instruction: '末尾抛一个低门槛问题，给朋友评论的理由，而不是干晒等赞。',
              example: '结尾"你们团队用什么协作工具？求安利"——把单向展示变成双向互动。',
              tip: '互动率决定朋友圈可见度，钩子是杠杆。',
              keywords: ['钩子', '低门槛', '互动率'],
            ),
            KnowledgeGuideStep(
              title: '第三步：发布后经营',
              instruction: '认真回评论、接梗、对关心的朋友私聊致谢；不秒删、不反复改。',
              example: '朋友评论"牛啊"，回"哈哈运气好，下次请你喝庆功咖啡"。',
              tip: '发布只是开始，互动经营才决定这条动态的社交收益。',
              keywords: ['回评', '私聊致谢', '不删'],
            ),
          ],
        ),
    ...
    'K083': KnowledgeExtensionBundle(
      ...
      stepGuides: [
        ...
        KnowledgeStepGuide(
          id: 'K083-G3',
          title: '实战情景：用八步法判断「同事介绍的女同学」',
          scenario: '把一个具体对象套进八步法+决策树，练一遍完整判断',
          steps: [
            KnowledgeGuideStep(
              title: '情景开场：同事介绍的女同学，聊天积极但约不出',
              instruction: '这是典型「聊天热、约会冷」信号。别被聊天热度带偏，先跑八步法采集多维信号。',
              example: '她秒回、爱发表情包，但你说"周末看展"她总说忙。',
              tip: '聊天是必要非充分条件，约不出=定位存疑。',
              keywords: ['多维信号', '约不出', '不被带偏'],
            ),
            KnowledgeGuideStep(
              title: '第一步：沟通 vs 约会交叉验证',
              instruction: '把「沟通信号」和「约会邀约态度」放一起看：聊得热但三次邀约都推=朋友/备胎定位。',
              example: '第三次约她，她说"最近项目紧，改天吧"且没主动给替代时间。',
              tip: '真有兴趣的人会主动补一个时间，而不是让你无限等。',
              keywords: ['交叉验证', '三次推脱', '不补时间'],
            ),
            KnowledgeGuideStep(
              title: '第二步：设止损线并测试',
              instruction: '停止主动邀约，改为「轻量存在」（偶尔轻松消息），观察她是否主动找你。两周无主动=定位低。',
              example: '你停邀约后，她从每天聊变成三天一条，从不主动约。',
              tip: '测试的是「她会不会主动」，不是你更要努力。',
              keywords: ['止损线', '停止邀约', '测主动'],
            ),
            KnowledgeGuideStep(
              title: '第三步：决策与执行',
              instruction: '信号综合后下结论：若持续冷淡→降温/撤退，把精力转向更值得的人；若她主动升温→跟进。',
              example: '两周测试她零主动，你礼貌降温，转而投入另一个双向的人。',
              tip: '决策要落地执行，判断完不行动等于没判断。',
              keywords: ['决策', '降温', '转向'],
            ),
          ],
        ),
    ...
    'K084': KnowledgeExtensionBundle(
      ...
      stepGuides: [
        ...
        KnowledgeStepGuide(
          id: 'K084-G3',
          title: '实战情景：判断「聚会认识的男生」是真兴趣还是海王',
          scenario: '把一个暧昧男生套进八步法+决策树，练一遍完整判断',
          steps: [
            KnowledgeGuideStep(
              title: '情景开场：聚会认识的男生，加微信后聊得勤，但忽冷忽热',
              instruction: '忽冷忽热本身是定位不明/备胎信号。先跑八步法采集多维信号，别急着投入情绪。',
              example: '前三天早晚安、第四天起隔天才回、周末消失——典型的「养鱼」节奏。',
              tip: '情绪被他牵着走，是最贵的消耗。先观察，再投入。',
              keywords: ['忽冷忽热', '定位不明', '不急投入'],
            ),
            KnowledgeGuideStep(
              title: '第一步：投入信号 vs 社交信号',
              instruction: '看他是否为你投入具体资源（时间规划/主动买单/记住细节），而非只在微信上低成本活跃。',
              example: '他微信秒回但不记得你说过不吃香菜，也从没主动规划过一次完整约会。',
              tip: '微信活跃是低成本，记住细节和主动规划才是真投入。',
              keywords: ['投入信号', '记住细节', '主动规划'],
            ),
            KnowledgeGuideStep(
              title: '第二步：社交圈开放度测试',
              instruction: '试探他是否愿意把你带入生活圈，或你提「见你朋友」时他的反应。',
              example: '你说"下次带上我呗"，他说"我朋友都太闹了，怕你不喜欢"——模糊回避。',
              tip: '真想发展的人，会主动创造让你进圈的机会，而不是找理由回避。',
              keywords: ['社交圈', '见朋友', '模糊回避'],
            ),
            KnowledgeGuideStep(
              title: '第三步：设止损线并决策',
              instruction: '给他2-3周观察窗口，若持续单向（你主动多、他少）、忽冷忽热、不开放社交圈→降温/止损。',
              example: '三周后他仍只在深夜找你聊、从不单独约白天活动→判定短期暧昧，你主动降温。',
              tip: '值得的人让你安心，不值得的人让你一直猜。把精力收回来。',
              keywords: ['止损线', '观察窗口', '降温'],
            ),
          ],
        ),
      ],
